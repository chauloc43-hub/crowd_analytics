...
class ApiSettings:
    ...
    def from_environment(cls) -> "ApiSettings":
        ...
        return cls(
            ...
            gender_model_path=os.getenv("GENDER_MODEL_PATH") or str(root / "artifacts" / "gender_classifier" / "best_model.pth"),


            max_live_sessions=_positive_int_from_environment("API_MAX_LIVE_SESSIONS", 10),
